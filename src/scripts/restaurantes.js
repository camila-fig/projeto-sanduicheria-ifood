...
const opções = ['Italiano', 'Grelhado', 'Bacon', 'Queijo', 'Rosbife'] // Array de todas as opções de itens para 
//comparação com o selecionado nos prompts
const sacola = [] // Array da sacola, itens adicionados entram aqui

function addGeral () { // Botão de adicionar, prompt pede pro cliente digitar o nome do item e a quantidade que 
//deseja adicionar e inclui isso no array da Sacola
